...
public class calculatorServelet extends HttpServlet{
	public doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException{
		...
		request.setAtrribute("num1", num1);
		request.setAtrribute("num2", num2);
